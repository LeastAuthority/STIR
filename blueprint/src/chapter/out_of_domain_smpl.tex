\section{Out of Domain Sampling}
\begin{lemma}
    ...
    \begin{align*}
    \Pr_{r_1,\ldots,r_l\gets\field\setminus\evaldomain}[\exists\text{ distinct }u,u'\in\listcode(f,\degree,\distance):\forall i\in[s],\hat{u}(i)=\hat{u}'(i)] & \leq \binom{l}{2}\cdot{\Big(\frac{\degree-1}{|\field|-|\evaldomain|}\Big)}^s \\
