...
%\leanok
\uses{def:combine}
    Given target degree $\degree\in\N$, shifting parameter $r$, function $f:\evaldomain\rightarrow\field$, and degree $0\leq\degree\leq\degree^*$, we define $\degcorr(\degree^*,r,f,\degree)$ as follows.
    \[
